...
public:
    ...
    void setPhdData(vector<Phd*>);
    void setNonPhdData(vector<NonPhd*>);
    void setFacultyData(vector<Faculty*>);
    void setStaffData(vector<Staff*>);
    void setResourceData(vector<Resource*>);
};
...
public:
    ...
    string getdata()
    {
        return (string)"Phd"+"\n"+Student::getdata()+"\n"+to_string(num_of_journals_issued)+"\n"+"\\Phd";
    }
    static int getmaxdays(){return maxdays;}
};
...
void Library::setPhdData(vector<Phd*> phd)
{
    for(int i = 0; i < phd.size(); i++)
    {
        Library::member.push_back(phd[i]);
        Library::phd.push_back(phd[i]);
    }
}
void Library::setNonPhdData(vector<NonPhd*> nphd)
{
    for(int i = 0; i < nphd.size(); i++)
    {
        Library::member.push_back(nphd[i]);
        Library::nphd.push_back(nphd[i]);
    }
}
void Library::setFacultyData(vector<Faculty*> faculty)
{
    for(int i = 0; i < faculty.size(); i++)
    {
        Library::member.push_back(faculty[i]);
        Library::faculty.push_back(faculty[i]);
    }
}
void Library::setStaffData(vector<Staff*> staff)
{
...
void Library::setResourceData(vector<Resource*> res)
{
    for(int i = 0; i < res.size(); i++)
    {
        Library::resources.push_back(res[i]);
    }
}
...
void loaddata(Library &lib)
{
    ...
    lib.setFacultyData(faculty);
    lib.setPhdData(phd);
    lib.setNonPhdData(nonphd);
    lib.setStaffData(staff);
    vector<Resource*> res;
    for(int i = 0; i < resource_book.size(); i++)
    {
        res.push_back(resource_book[i]);
    }
    for(int i = 0; i < resource_journal.size(); i++)
    {
        res.push_back(resource_journal[i]);
    }
    lib.setResourceData(res);
